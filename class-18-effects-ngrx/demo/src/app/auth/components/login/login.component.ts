...
import { SessionState } from 'src/app/core/state/sesion.reducer';
...
export class LoginComponent implements OnInit {
  ...
  constructor(
    ...
    this.formulario = fb.group({
      usuario: new FormControl('Ezekiel_Price47', [Validators.required]),
      contrasena: new FormControl('Dc35gknSOZxKgWq', [Validators.required]),
    })
  }
