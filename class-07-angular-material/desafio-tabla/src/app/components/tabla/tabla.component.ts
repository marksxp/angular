...
const ELEMENT_DATA: Curso[] = [
  ...
  {nombre: 'SQL', comision: '31320', profesor: 'Abner Garcia', numeroEstudiantes: 44, matriculaAbierta: true},
...
export class TablaComponent implements OnInit {
  ...
  columnas: string[] = ['nombre', 'profesor', 'numeroEstudiantes', 'matriculaAbierta', 'acciones'];
  ...
  // ng g c components/editar-dialog --module app.module
}
